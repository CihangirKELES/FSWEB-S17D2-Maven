...
public class DeveloperFactory {
    ...
    public static Developer createDeveloper(Developer developer, Taxable taxable) {
        ...
        if (developer.getExperience().equals(Experience.JUNIOR)) {
            ...
            createdDeveloper = new SeniorDeveloper(developer.getId(), developer.getName(), developer.getSalary() - (developer.getSalary() * taxable.getMiddleTaxRate()) / 100);
        } else {
            System.out.println("unknown experince");
            return null;
        }
