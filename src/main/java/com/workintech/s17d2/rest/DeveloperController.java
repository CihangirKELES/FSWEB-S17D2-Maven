...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1, new SeniorDeveloper(1, "cihangir", 1000d));
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id) {
        ...
        if(foundDeveloper == null) {
            return new DeveloperResponse(null, id + "ile search yapıldığında kayıt bulunamadı.", HttpStatus.NOT_FOUND.value());
        }
